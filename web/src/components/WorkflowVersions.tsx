...
export function WorkflowVersions({
  ...
  const handleActivateVersion = (version: WorkflowVersion) => {
    if (
      confirm(
        `Are you sure you want to activate version ${version.version}? This will make it the active version for new executions.`
      )
    ) {
      setVersions((prev) =>
        prev.map((v) => ({
      ...
      <div className="container">
        <div className="workflow-versions">
          ...
          <Modal
            ...
            ariaLabelledBy="version-details-title"
            title={
              selectedVersion ? `Version ${selectedVersion.version} Details` : 'Version Details'
            }
            ...
            {selectedVersion && (
              <>
                ...
                <div className="modal-footer">
                  <button className="btn btn-secondary" onClick={() => setSelectedVersion(null)}>
                    Close
                  </button>
                  <button
          ...
          <Modal
            ...
            ariaLabelledBy="create-version-title"
              ...
              <div className="form-fields">
                ...
                <div className="field-group">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewVersionData((prev) => ({ ...prev, description: e.target.value }))
                    }
                ...
                <div className="version-info-notice">
                  <AlertCircle size={16} />
                  <span>
                    The new version will be created as a draft based on the current workflow state.
                  </span>
                </div>
              </div>
            </div>
