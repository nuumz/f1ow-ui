...
export default function WorkflowTemplates({ onUseTemplate }: Readonly<WorkflowTemplatesProps>) {
            ...
            {filteredTemplates.map((template) => (
              <div key={template.id} className="template-card">
                ...
                <div className="template-actions">
                  ...
                  <button className="btn btn-primary" onClick={() => onUseTemplate(template)}>
                    <Download size={14} />
                    Use Template
                  </button>
                </div>
                ...
                <div className="modal-body">
                  <div className="preview-info">
                    ...
                    <div className="preview-stats">
                      ...
                      <div className="stat">
                        <div className="stars">{renderStars(previewTemplate.rating)}</div>
