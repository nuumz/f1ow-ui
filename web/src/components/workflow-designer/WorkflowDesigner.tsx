            ...
            <WorkflowCanvas
              ...
              canDropOnPort={(
                ...
                if (state.designerMode === 'architecture') {
                  if (process.env.NODE_ENV === 'development') {
                    console.log(
                      '🏗️ Architecture mode: SKIPPING duplicate check, allowing multiple connections'
                    );
                  }
                  ...
                  if (connectionStart.type === 'input' && portType === 'output') {
                    console.log(
                      '✅ Architecture mode: Allowing input -> output connection (reverse)',
                      {
                        sourceNodeId: connectionStart.nodeId,
                        sourcePortId: connectionStart.portId,
                        targetNodeId,
                  ...
                  if (!portType) {
                    console.log(
                      '✅ Architecture mode: Allowing connection (no portType specified)'
                    );
                    return true;
                  }
